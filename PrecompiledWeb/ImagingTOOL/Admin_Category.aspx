<%@ page title="" language="C#" masterpagefile="~/Main.master" autoeventwireup="true" inherits="Admin_Category, App_Web_okblpzmr" viewStateEncryptionMode="Never" %>
                     ...
                     <Columns>
                        ...
                        <asp:TemplateField HeaderText="Category" ItemStyle-HorizontalAlign="Center" HeaderStyle-Width="50px">
                            ...
                            <EditItemTemplate>
                                ...
                                <asp:TextBox ID="txtbox_Category" runat="server" Text='<%#Eval("Category_Name")%>' Width="50px" Height="30px"></asp:TextBox>
                            </EditItemTemplate>
                        </asp:TemplateField>
