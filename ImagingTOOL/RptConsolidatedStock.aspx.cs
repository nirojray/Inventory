...
public partial class RptConsolidatedStock : System.Web.UI.Page
{
    ClsReportStock objCSR = new ClsReportStock();
    ...
    protected void BtnExport_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            DataTable DTSO = objCSR.Cosolidated_Stock(FromDate, ToDate);
            if (DTSO.Rows.Count > 1)
            {
                ...
                string rptHeading = "Consolidated Stock Summary";
                ss = ConvertDataTableToHTML(DTSO, rptHeading);

                Response.AppendHeader("content-disposition", "attachment;filename=Consolidated Stock Summary.xls");
                Response.Charset = "";
