...
public partial class SalesInvoiceCreditNotePDF : System.Web.UI.Page
{
    int value;
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            LoadCreditNoteSINumber();
            // LoadGridDetails();
            Panel1.Visible = false; TblCgst.Visible = false; tblIGST.Visible = false;
        }
    }

    private void LoadCreditNoteSINumber()
    {
        try
        {
            DataTable dt = ClsMaster.GetCreditNoteSINumber();
            ...
            ddlSONumber.Items.Insert(0, new System.Web.UI.WebControls.ListItem("--Select Sales Invoice NO--", "0"));
    ...
    protected void btnExport_Click(object sender, EventArgs e)
    {
        ...
        if (value != 0)
        {
            ...
            if (SalesType == "CGST-SGST-INTRA STATE")
            {
                ...
                Response.AddHeader("content-disposition", "attachment;filename=CreditNote.pdf");
