// Desarrollado por: Ricaute Jimnez Snchez (La Chorrera, Panam)
// Componente: PopCalendar.js(3.2.9)
// Correo: ricaj0625@yahoo.com
// ltima actualizacin: 30 de noviembre de 2006
// Por favor mantenga estos crditos (Please, keep these credits)

if(typeof(objPopCalList)=='undefined')
{
	var objPopCalList=[];
	var PopCalendar={majorVersion:3,minorVersion:2.9,newCalendar:new Function("_name","return(PopCalGetCalendarInstance(_name))")};
}
...
function PopCalConstructCalendar(l)
{
	...
	var sPad="&nbsp;";
	//Martes de Carnaval y Viernes Santo para el ao actual
