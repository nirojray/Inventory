<%@ Page Title="" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true" CodeFile="Rpt_GoodsReceived_BillPending.aspx.cs" EnableEventValidation="false" Inherits="Rpt_GoodsReceived_BillPending" %>
               ...
               <div class="span12">
                  ...
                  <h3 class="page-title">
                   ...
                   <ul class="breadcrumb">
                    ...
                    <li> <a href="Rpt_GoodsReceived_BillPending.aspx">Purchase Bill Pending</a><span class="divider-last">&nbsp;</span></li>
                   </ul>
               </div>
            </div>
            <!-- END PAGE HEADER-->
                ...
                <div class="span12 sortable">
                    ...
                    <div class="widget">
                        <div class="widget-title">
                            <h4>Purchase Bill Pending-Goods Received But Bill Not Received</h4>
                                        <span class="tools">
