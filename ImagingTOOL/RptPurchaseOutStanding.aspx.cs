...
public partial class RptPurchaseOutStanding : System.Web.UI.Page
{
    ClsPurchaseOutstandingRpt objPO = new ClsPurchaseOutstandingRpt();
    ...
    protected void BtnExport_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            DataTable DTSO = objPO.Get_Purchaseoutstanding(FromDate, ToDate);
            if (DTSO.Rows.Count > 1)
            {
                ...
                string rptHeading = "PURCHASE ORDER OUTSTANDING SUMMARY";
                ss = ConvertDataTableToHTML(DTSO, rptHeading);

                Response.AppendHeader("content-disposition", "attachment;filename=Purchase Outstanding Summary.xls");
                Response.Charset = "";
