...
using System.IO;
public partial class Rpt_GoodsReceived_BillPending : System.Web.UI.Page
{
    ClsPurchaseBillPendingRpt objBP = new ClsPurchaseBillPendingRpt();
    ...
    protected void BtnExport_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            DataTable DTSO = objBP.Get_PurchaseBillPending(FromDate, ToDate);
            if (DTSO.Rows.Count > 1)
            {
                ...
                string rptHeading = "Purchase Bill Pending- Goods Received But Bill Not Received";
                ss = ConvertDataTableToHTML(DTSO, rptHeading);

                Response.AppendHeader("content-disposition", "attachment;filename=Purchase Bill Pending.xls");
                Response.Charset = "";
