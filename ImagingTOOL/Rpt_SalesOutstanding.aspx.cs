...
using System.IO;
public partial class Rpt_SalesOutstanding : System.Web.UI.Page
{
    ClsSalesOutStandingRpt objSO = new ClsSalesOutStandingRpt();
    ...
    protected void BtnExport_Click(object sender, EventArgs e)
    {
        try {
            ...
            DataTable DTSO = objSO.Get_Salesoutstanding(FromDate, ToDate);
            if (DTSO.Rows.Count > 1)
            {
                ...
                string rptHeading = "SALES ORDER OUTSTANDING SUMMARY";
                ss = ConvertDataTableToHTML(DTSO, rptHeading);

                Response.AppendHeader("content-disposition", "attachment;filename=Sales Outstanding Summary.xls");
                Response.Charset = "";
