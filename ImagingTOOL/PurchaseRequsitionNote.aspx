<%@ Page Title="" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true" CodeFile="PurchaseRequsitionNote.aspx.cs" Inherits="PurchaseRequsitionNote" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script type="text/javascript">
     ...
     <script language="javascript" type="text/javascript">
         function validateMandatory() {
             ...
             else if (document.getElementById('<%=txtTermsOfDelievery.ClientID %>').value == "") {
                 alert("Please Enter Terms Of Delivery");
                 document.getElementById('<%=txtTermsOfDelievery.ClientID %>').focus();
                 return false;
             }
            ...
            else if (document.getElementById('<%=ddlPurchaseType.ClientID%>').selectedIndex == 0) {
            ...
            <%-- else if (document.getElementById("<%= ChkSpa.ClientID %>").checked == true) {                  
                 if (document.getElementById('<%=ddlSpaNum.ClientID%>').selectedIndex == 0) {                     
                     alert("Please Select SPA Number");
                     return false;
                 }
             }--%>
         } 
 ...
 <style  type="text/css">
    ...
    function enableTextBox() {
        var textBoxID = "<%= TxtSpaNum.ClientID %>";
        if (document.getElementById("<%= ChkSpa.ClientID %>").checked == true) {
    ...
    <div id="main-content">
        ...
        <div class="container-fluid">
            ...
            <div class="row-fluid">
                <div class="span12">
                    <h3 class="page-title">Purchase Requisition Note (PRN) 
                    </h3>
                    <ul class="breadcrumb">
                        <li><a href="Workflow.aspx"><i class="icon-home"></i></a><span class="divider">&nbsp;</span>
                        </li>
                        <li><a href="#">Purchase Requisition Note (PRN) </a><span class="divider">&nbsp;</span> </li>
                        <li><a href="PurchaseRequsitionNote.aspx">Purchase Requisition Note (PRN) </a><span class="divider-last">&nbsp;</span></li>
                    </ul>
                </div>
            </div>
            <!-- END PAGE HEADER-->
                    ...
                    <div class="widget">
                        <div class="widget-title" style="height: 50px">
                            <h4>
                                ...
                                Purchase Requisition Note (PRN)</h4>
                            ...
                            <table style="width: 100%">
                              ...
                              <%--  edited by eliyas --starr----%>
                                <tr>
                                    ...
                                    <td>
                                       <asp:TextBox ID="txtPan" ReadOnly="true" runat="server" MaxLength="50" Width="210px"></asp:TextBox>
                                    </td>

                                </tr>
                                  <%--  edited by eliyas --end----%>
                                ...
                                <tr>    
                                    ...
                                    <td id="td3" runat="server">SPA<span style="color: Red">*</span>                                  
                                        <asp:CheckBox ID="ChkSpa" runat="server" Checked="false" AutoPostBack="true" OnCheckedChanged="ChkSpa_CheckedChanged"/>
                                    </td>
                                    <td id="td5" runat="server" colspan="2"> 
                                        <asp:DropDownList ID="ddlSpaNum" runat="server" Enabled="false" AutoPostBack="true" OnSelectedIndexChanged="ddlSpaNum_SelectedIndexChanged"></asp:DropDownList>                                                                      
                                       <%--<asp:TextBox ID="TxtSpaNum" runat="server" Enabled="false" ></asp:TextBox>
                                        <asp:TextBoxWatermarkExtender ID="txtSPAWaterMark" runat="server" TargetControlID="TxtSpaNum" WatermarkText="SPA Number"></asp:TextBoxWatermarkExtender>--%>
                                    </td>                           
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:DropDownList ID="ddlPurchaseType" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddlPurchaseType_SelectedIndexChanged" ></asp:DropDownList>
                                    </td>                                    
                                ...
                                <tr>
                                    ...
                                    <td style="margin-left: 40px" id="td2" runat="server">
                                       <asp:TextBox ID="TxtHSN_SAC_Code" runat="server" ReadOnly="True"></asp:TextBox>
                                    </td>  
                                 ...
                                 <tr>
                                    <td id="tdVndr" runat="server" colspan="2">Vendor<span style="color: Red">*</span></td>
                                            ...
                                            <tr>
                                                ...
                                                OnClick="BtnPurchaseOrderSave_Click" /> &nbsp;
                                                    <asp:Button ID="Button1" runat="server" ForeColor="Black" class="btn-success"
                                                        Text="Clear PRN" OnClick="BtnPurchaseOrderClear_Click" />                                                  
