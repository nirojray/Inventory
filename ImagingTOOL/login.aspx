...
<body onload="getload();">
                        ...
                        <tr>
                           <td style="width: 163px; height: 30px;">
                               <asp:Button ID="btnLogin" runat="server" OnClick="btnLogin_Click"  Text=" Sign In" 
                                style="background:#1669b3; border:0; font-weight:700; color:#fff; width:75px;"/>
                                <asp:HiddenField ID="hid1" Value="" runat="server"  />
                           </td>
                            <td align="left" style="width: 163px; height: 30px;" >
                                <asp:LinkButton ID="lnkLogin" runat="server" Text="Forgot Password" PostBackUrl="~/forget.aspx" Font-Underline="true"></asp:LinkButton>                                
                            </td>
        ...
        <div style="margin-top:3px;font-size:13px;font-family:calibri;color:#959595"><center /> &copy; 2018 Service as a platform Offered by Centillion Solutions and Services. All Rights Reserved.
        </div>
</body>
</html>