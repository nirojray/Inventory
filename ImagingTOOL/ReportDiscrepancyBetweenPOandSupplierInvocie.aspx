<%@ Page Title="" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true" EnableEventValidation="false" CodeFile="ReportDiscrepancyBetweenPOandSupplierInvocie.aspx.cs" Inherits="DiscrepancyBetweenPOandSupplierInvocie" %>
               ...
               <div class="span12">
                  ...
                  <h3 class="page-title">
                   ...
                   <ul class="breadcrumb">
                    ...
                    <li> <a href="ReportDiscrepancyBetweenPOandSupplierInvocie.aspx">Discrepancy Between PO and Supplier Invocie</a><span class="divider-last">&nbsp;</span></li>
                   </ul>
               </div>
            </div>
            <!-- END PAGE HEADER-->
                ...
                <div class="span12 sortable">
                    ...
                    <div class="widget">
                        <div class="widget-title">
                            <h4>Discrepancy Between PO and Supplier Invocie Report</h4>
                                        <span class="tools">
                        ...
                        <rjs:PopCalendar ID="PopCalendar4" runat="server" ShowErrorMessage="False" Separator="-"
                                    ...
                                    <td>
                                        <asp:Button ID="BtnExport0" runat="server" Text="Export" onclick="BtnExport0_Click" 
                                            />
                                    </td>
                                    <td>
                                        &nbsp;</td>
