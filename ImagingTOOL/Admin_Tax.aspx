<%@ Page Title="" Language="C#" MasterPageFile="~/Main.master" EnableEventValidation="false" AutoEventWireup="true" CodeFile="Admin_Tax.aspx.cs" Inherits="Admin_Tax" %>
                                 ...
                                 <tr>
                                  ...
                                  <tr>
                                     <td style="width: 185px">
                                          Base Value</td>
                                     <td>
                                         <asp:TextBox ID="txtBasevalue" runat="server" Width="222px" onkeypress="return isNumberKey(event)"></asp:TextBox>
                                     </td>
                                 </tr>
