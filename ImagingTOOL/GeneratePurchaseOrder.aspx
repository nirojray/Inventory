<%@ Page Title="" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true" CodeFile="GeneratePurchaseOrder.aspx.cs" EnableEventValidation="false" Inherits="GeneratePurchaseOrder" %>
            ...
            <div class="row-fluid">
                <div class="span12">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li><a href="GeneratePurchaseOrder.aspx">Generate Purchase Order</a><span class="divider-last">&nbsp;</span></li>
                    </ul>
                </div>
            </div>
            <!-- END PAGE HEADER-->
                            ...
                            <asp:Panel ID="Panel1" runat="server">
                                ...
                                <div class="widget-body">
                                    <table style="width: 100%">
                                        <tr>
                                            <td class="input-mini" style="width: 85px">PRN No. &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
                                                <asp:TextBox ID="TxtPoNo" runat="server" Width="200px" ReadOnly="True"></asp:TextBox>
                                            </td>                                            
                                            <td style="width: 77px" class="input-mini">PRN Date &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
                                                <asp:TextBox ID="TxtPoDate" runat="server" ReadOnly="True"></asp:TextBox>
                                            </td>                                           
                                        </tr>
                                        <tr>
                                            <td class="input-mini" style="width: 250px">Supplier &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
                                                 <asp:TextBox ID="TxtPoSupplier" runat="server" ReadOnly="True" Width="210px"></asp:TextBox>
                                            </td>  
                                            <td class="input-mini" style="width: 250px">Supplier State &nbsp&nbsp&nbsp&nbsp
                                                 <asp:TextBox ID="txtSupplierState" runat="server" ReadOnly="True" Width="210px"></asp:TextBox>
                                            </td> 
                                        </tr>
                                        <tr>
                                            ...
                                            <td class="input-mini" style="width: 75px">Location  &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
                                                 <asp:TextBox ID="TxtPoLocation" runat="server" ReadOnly="True"></asp:TextBox>
                                            </td> 
                                               
                                        </tr>
                                          <tr>
                                              <td class="input-mini" style="width: 75px">Supplier GST NO &nbsp
                                                 <asp:TextBox ID="TxtGST" runat="server" ReadOnly="True"></asp:TextBox>
                                            </td>  
                                            <td class="input-mini" style="width: 75px">Payment Terms &nbsp&nbsp
                                        ...
                                        <tr>
                                            <td class="input-mini" style="width: 75px">Reverse Charges &nbsp
                                                 <asp:TextBox ID="txtrevers" runat="server" ReadOnly="True"></asp:TextBox>
                                            </td>  
                                           <td class="input-mini" style="width: 75px">PAN Num &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
                                        ...
                                        <tr>
                                            <td style="width: 168px" runat="server">Terms Of Delivery&nbsp&nbsp
                                             ...
                                             <td class="input-mini" style="width: 75px">Main Category &nbsp&nbsp&nbsp&nbsp
                                          ...
                                          <tr>
                                               <td style="width: 168px" runat="server"><asp:Label ID="lbl_hsnac" runat="server"></asp:Label> &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
                                                 <asp:TextBox ID="txt_hsnac" runat="server" ReadOnly="True"></asp:TextBox>
                                            </td>  
                                                   
                                             <td class="input-mini" style="width: 75px" id="TrWarranty" runat="server">Warranty &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
                                        ...
                                        <tr>
                                             <td style="width: 168px">Purchase Type&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
                                            ...
                                            <%--<td style="width: 168px">Total Amount&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
                                                 <asp:TextBox ID="TxtTotalAmount" runat="server" ReadOnly="True"></asp:TextBox>
                                            </td>--%>
                                        </tr> 
                                        <tr id="trSpaNum" runat="server">
                                            <td style="width: 168px">SPA Number&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
                                                 <asp:TextBox ID="TxtSPANumber" runat="server" ReadOnly="True"></asp:TextBox>
                                            </td>
                                        </tr>
                                    </table>
                                    <table border="1">
                                    ...
                                    <br />
                                        <div  style="width: 100%" align="center">                                          
                                           <asp:Button ID="BtnGeneratePO" runat="server" ForeColor="Black" class="btn-success"
                                               Text="Generate PO" OnClick="BtnGeneratePO_Click" />
