...
namespace Comman
{
    public class ITextEvents : PdfPageEventHelper
    {
        ...
        public override void OnEndPage(iTextSharp.text.pdf.PdfWriter writer, iTextSharp.text.Document document)
        {
            ...
            string pdfpathfoot = HttpContext.Current.Server.MapPath(".") + "/images/footer600.png";
            ...
            pdfTabfooter.WriteSelectedRows(0, -1, 0, document.PageSize.GetBottom(80), writer.DirectContent);
