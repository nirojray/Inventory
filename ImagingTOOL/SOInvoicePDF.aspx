<%@ Page Title="" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true" CodeFile="SOInvoicePDF.aspx.cs" EnableEventValidation="false" Inherits="SOInvoicePDF" %>
            ...
            <div class="row-fluid">
                <div class="span12">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li><a href="SOInvoicePDF.aspx">Sales Order Invoice(PDF)</a><span class="divider-last">&nbsp;</span></li>
                    </ul>
                </div>
            </div>
            <!-- END PAGE HEADER-->
                                            ...
                                            <tr>
                                             ...
                                             <tr>
                                                 ...
                                                 <td>
                                                    ...
                                                    <span style="font-size: 9; font-family: Times New Roman; font-weight: lighter">
                                                        <asp:Label ID="lblHDCNum" Text="DC number :" runat="server" Visible="false"></asp:Label>
                                                    </span>
                                                   
                                                    </td>
                                                   <td>                                                  
                                                    <span style="font-size: 9; font-family: Times New Roman; font-weight: lighter">
                                                        <asp:Label ID="lblDCNum" runat="server" Visible="false"></asp:Label>
                                                    </span>                                                   
                                                    </td>
                                            ...
                                            <table border="1">
                                                <tr>
                                                    <td><span style="font-size: 9; font-family: Times New Roman; font-weight: lighter">
                                                        <asp:Label ID="Label11" runat="server" Text="Bank Details: Axis bank limited"></asp:Label>
                                                    </span>
                                                    </td>  
                                                    <td>
                                                        <span style="font-size: 9; font-family: Times New Roman; font-weight: lighter">
