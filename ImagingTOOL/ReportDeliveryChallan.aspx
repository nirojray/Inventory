<%@ Page Title="" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true" EnableEventValidation="false" CodeFile="ReportDeliveryChallan.aspx.cs" Inherits="ReportDeliveryChallan" %>
                           ...
                           Width="100%" BackColor="White" BorderColor="#999999" BorderStyle="Solid" 
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Name Of The Transporter">
                                        <ItemTemplate>
                                            <asp:Label ID="lblNameOfTheTransporter" runat="server" Text='<%# Eval("Material NameOfTheTransporter") %>'></asp:Label>
                                            <asp:HiddenField ID="HidCatagory" runat="server" />
                                        </ItemTemplate>
                                        
                                    </asp:TemplateField>
                                   
                                    <asp:TemplateField HeaderText="Material Dispatch Details">
                                        <ItemTemplate>
                                            <asp:Label ID="DispatcDetails" runat="server" Text='<%# Eval("Material DispatcDetails") %>'></asp:Label>
                                        </ItemTemplate>
                                       
                                    </asp:TemplateField>
                                   
                                    <asp:TemplateField HeaderText="Material Dispatch Date">
                                        <ItemTemplate>
                                            <asp:Label ID="LblDispatchDate" runat="server" Text='<%# Eval("Material DispatchDate") %>'></asp:Label>
                                        </ItemTemplate>
                                        
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Material Date Of Delivery">
                                        <ItemTemplate>
                                            <asp:Label ID="LblDateOfDelivery" runat="server" Text='<%# Eval("Material DateOfDelivery") %>'></asp:Label>
                                        </ItemTemplate>
                                   ...
                                   <%-- <asp:TemplateField HeaderText="Date Of Installation">
                                    ...
                                    <asp:TemplateField HeaderText="Material Dispatch Entered By">
                                        <ItemTemplate>
                                            <asp:Label ID="Lblenteredby" runat="server" Text='<%# Eval("Material Dispatch Entered By") %>'></asp:Label>
                                        </ItemTemplate>
                                      
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Material Dispatch Entered On">
                                        <ItemTemplate>
                                            <asp:Label ID="LblEnteredOn" runat="server" Text='<%# Eval("Material Dispatch Entered On") %>'></asp:Label>
                                        </ItemTemplate>
